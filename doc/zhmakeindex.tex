...
\indexentry{简介}{i}
\indexentry{字体|(}{2}
\indexentry{font|see{字体}}{2}
\indexentry{字体!族}{2}
\indexentry{字体!族!Times}{2}
\indexentry{字体!族!Computer Modern}{3}
\indexentry{字体!重量}{4}
\indexentry{字体|)}{5}
\indexentry{射线!X 射线}{7}
\indexentry{射线!$\Gamma$ 射线@Gamma 射线}{8}
\indexentry{Aha"!}{9}
\indexentry{G\"odel}{10}
\end{verbatim}
...
种格式。标准的 \pkg{makeindex} 还允许多级页码，但 \zhm 暂不支持。
